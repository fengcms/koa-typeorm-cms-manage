<template>
  <el-dialog :title="`${actionText}会员`" :visible="visible" width="620px" :close-on-click-modal="false" :close-on-press-escape="false" @open="init" @close="close">
      ...
      <el-form ref="ruleForm" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="性别" prop="sex">
          <el-radio-group v-model="form.sex">
            <el-radio-button label="MAN">男生</el-radio-button>
            <el-radio-button label="WOMAN">女生</el-radio-button>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="个性签名" prop="signature">
          <el-input v-model="form.signature" type="textarea" autocomplete="off" style="width: 500px" />
        </el-form-item>
